...
$iTXT.js.loader["$iTXT.oldui.ComponentBase"]=true;$iTXT.oldui.ComponentBase_Load=function(){var undefined;$iTXT.oldui.ComponentBase=$iTXT.core.Class.create({options:null,rootElement:null,width:undefined,height:undefined,left:undefined,top:undefined,init:function(_options)
{this.options=$iTXT.core.Util.extend({id:"itxtcomponent",className:""},_options);this.children=[];this.rootElement=$iTXT.core.Builder.make("DIV",{id:this.options.id,className:this.options.className});},resize:function()
...
{this.addChild(children[childComp]);}},show:function()
...
{t.isOpen=false;$iTXT.core.$("vm_ttso").style.display="none";}

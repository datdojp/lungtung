...
/* Làm cho tab "Trang" tại [[Trang Chính]] trở thành chữ "Trang chính".
 * Phải thay đổi đặc biệt do skin Vector bọc tên tab trong thẻ <span>
 * để làm cho tên tab không làm xô lệch hàng.
 **/
if (wgPageName == 'Trang_Chính' || wgPageName == 'Thảo_luận:Trang_Chính') {
     addOnloadHook(function () {
          var nstab = document.getElementById('ca-nstab-main')
          if (nstab && wgUserLanguage=='vi') 
          nstab.firstChild.firstChild.firstChild.nodeValue = 'Trang chính'
     } );
}